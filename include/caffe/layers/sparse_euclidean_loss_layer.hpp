#ifndef CAFFE_SPARSEEUCLIDEAN_LOSS_LAYER_HPP_
#define CAFFE_SPARSEEUCLIDEAN_LOSS_LAYER_HPP_
...
/**
 * @brief Computes the Euclidean (L2) loss where groundtruth is present, @f$
...
#endif  // CAFFE_SPARSEEUCLIDEAN_LOSS_LAYER_HPP_
