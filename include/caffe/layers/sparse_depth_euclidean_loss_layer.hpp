#ifndef CAFFE_SPARSEDEPTHEUCLIDEAN_LOSS_LAYER_HPP_
#define CAFFE_SPARSEDEPTHEUCLIDEAN_LOSS_LAYER_HPP_
...
class SparseDepthEuclideanLossLayer : public LossLayer<Dtype> {
 public:
  explicit SparseDepthEuclideanLossLayer(const LayerParameter& param)
      : LossLayer<Dtype>(param), diff_() {}
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);

  virtual inline const char* type() const { return "SparseDepthEuclideanLoss"; }
  /**
 ...
 protected:
  /// @copydoc SparseDepthEuclideanLossLayer
...
#endif  // CAFFE_SPARSEDEPTHEUCLIDEAN_LOSS_LAYER_HPP_
